class BestOfN:
    ...
    def run(self,task,n=3):
        ...
        judge=self.orchestrator.call("judge","Compare these candidate solutions. Select the strongest and synthesize an implementation plan.\n\n"+"\n\n--- CANDIDATE ---\n".join(candidates))
        return {"candidates":candidates,"judge":judge}
